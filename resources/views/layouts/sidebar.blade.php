<div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col border-r border-slate-600">
        <div class="flex grow flex-col bg-slate-900">
            <div class="border-b border-slate-600 p-4 flex items-center">
            ...
            <nav class="flex flex-1 flex-col p-4">
                <ul role="list" class="flex flex-1 flex-col gap-y-1 mx-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('companies.show') }}" class="{{ request()->is('*compan*') ? 'bg-slate-700  text-cyan-400' : 'text-cyan-100' }} hover:bg-slate-700 hover:text-cyan-400 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 {{ request()->is('*compan*') ? 'text-cyan-400' : 'text-cyan-100' }} group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <a href="{{ route('projects.index') }}" class="{{ request()->is('*project*') ? 'bg-slate-700 text-cyan-400' : 'text-cyan-100' }} hover:bg-slate-700 hover:text-cyan-400 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 {{ request()->is('*project*') ? 'text-cyan-400' : 'text-cyan-100' }} group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <a href="{{ route('tasks.index') }}" class="{{ request()->is('*task*') ? 'bg-slate-700 text-cyan-400' : 'text-cyan-100' }}  hover:bg-slate-700 hover:text-cyan-400 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 {{ request()->is('*task*') ? 'text-cyan-400' : 'text-cyan-100' }}  group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <a href="{{ route('users.index') }}" class="{{ request()->is('*user*') ? 'bg-slate-700 text-cyan-400' : 'text-cyan-100' }} hover:bg-slate-700 hover:text-cyan-400 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 {{ request()->is('*user*') ? 'text-cyan-400' : 'text-cyan-100' }} group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <a href="{{ route('info.show') }}" class="{{ request()->is('*info*') ? 'bg-slate-700 text-cyan-400' : 'text-cyan-100' }} hover:bg-slate-700 hover:text-cyan-400 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 {{ request()->is('*info*') ? 'text-cyan-400' : 'text-cyan-100' }} group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" aria-hidden="true">
            ...
            <div class="border-t border-slate-600 p-4 text-center text-cyan-100">
                &copy; 2024
            </div>
        </div>
    </div>
