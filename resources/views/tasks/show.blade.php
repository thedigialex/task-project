        ...
        <div class="modal-content flex flex-col self-center bg-gray-100 dark:bg-gray-200 p-2 rounded-lg w-full max-w-[500px]">
            ...
            <div class="flex flex-col pt-1" x-show="task.id">
                ...
                <div class="flex flex-row justify-evenly">
                    ...
                    <button class="close text-white bg-gray-600 hover:bg-gray-500 dark:bg-gray-500 dark:hover:bg-gray-600 shadow shadow-gray-400 hover:shadow-md hover:shadow-gray-400  rounded hover:cursor-pointer px-4 transition duration-150"
